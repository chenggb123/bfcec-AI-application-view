...
export type AdminView = 'dashboard' | 'products' | 'categories' | 'scenarios'
  ...
  return (
    <aside className={styles.sidebar}>
      ...
      <div className={styles.sidebarBrand}>
        ...
        <span>
          BFCEC <strong style={{ color: '#DA291C' }}>{'管理'}</strong>
        </span>
      </div>
      ...
      <nav className={styles.sidebarNav}>
        {navItems.map((item) => (
          <button
            key={item.view}
            className={
              currentView === item.view ? styles.navItemActive : styles.navItem
            }
